    ...
    *Arguments*
    ...
    def c2b(
        ...
        *Optional arguments*
        ...
        jsond = {
            ...
            "ThirdPartyReference": "R" + strdate(datetime.now()),
            "serviceprovidercode": self.C2B_Number,
            "token": str(self.token),
            "CallBackDestination": kwargs.get("callback_url", self.C2B_CB_URL),
            "client_callback_url": kwargs.get("client_callback_url"),
            "CommandId": self.C2B_CommandID,
    ...
    def b2c(self, customer_msisdn, amount, currency="CDF", *args, **kwargs):
        ...
        jsond = {
            "Amount": amount,
            "CustomerMSISDN": customer_msisdn,
            "TransactionDateTime": strdate(datetime.utcnow()),
            "ThirdPartyReference": "R" + strdate(datetime.now()),
            "shortcode": self.B2C_Number,
            "token": str(self.token),
            "CallBackDestination": kwargs.get("callback_url", self.B2C_CB_URL),
            "client_callback_url": kwargs.get("client_callback_url"),
            "CommandId": self.B2C_CommandID,
            "callback_channel": self.Callback_Channel,
